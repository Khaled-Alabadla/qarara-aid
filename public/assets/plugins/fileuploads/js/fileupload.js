...
(function (root, factory) {
    ...
    function Dropify(element, options) {
        ...
        var defaults = {
            ...
            error: {
                fileSize: "حجم الملف كبير ({{ value }} حد أدنى).",
                minWidth: "عرض الصورة صغير ({{ value }}}px حد أدنى).",
                maxWidth: "عرض الصورة كبير ({{ value }}}px حد أقصى).",
                minHeight:
                    "ارتفاع الصورة صغير  ({{ value }}}px حد أدنى).",
                maxHeight: "ارتفاع الصورة كبير ({{ value }}px حد أقصى).",
                imageFormat:
                    "هذا النوع من الصور غير مسموح. ({{ value }} فقط).",
                fileExtension: "هذا الملف غير مسموح. ({{ value }} فقط).",
            },
            tpl: {
