                    ...
                    <form class="form-horizontal" action="{{ route('employees.update', $employee->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control select2-no-search" name="position">
                                        <option value="مثبت"
                                            {{ old('position', $employee->position) == 'مثبت' ? 'selected' : '' }}>مثبت
                                        </option>
                                        <option value="عضو مجلس"
                                            {{ old('position', $employee->position) == 'عضو مجلس' ? 'selected' : '' }}>عضو
                                            مجلس</option>
                                        <option value="عقد"
                                            {{ old('position', $employee->position) == 'عقد' ? 'selected' : '' }}>عقد
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control select2-no-search" name="status">
                                        <option></option>
                                        <option value="متزوج"
                                            {{ old('status', $employee->status) == 'متزوج' ? 'selected' : '' }}>متزوج
                                        </option>
                                        <option value="أعزب"
                                            {{ old('status', $employee->status) == 'أعزب' ? 'selected' : '' }}> أعزب
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" value="{{ old('wife_name', $employee->wife_name) }}"
                                        class="form-control" name="wife_name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text"
                                        value="{{ old('wife_identity_number', $employee->wife_identity_number) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="family_size"
                                        value="{{ old('family_size', $employee->family_size) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
